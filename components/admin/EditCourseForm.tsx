...
export default function EditCourseForm({ course }: { course: CourseItem }) {
  ...
  const [formData, setFormData] = useState({
    ...
    listing: {
      ...
      mnemonic: course.listing?.mnemonic || '',
      mnemonicImage: course.listing?.mnemonicImage || '',
          ...
          <form onSubmit={handleSubmit} className="space-y-12">
              ...
              <div className="space-y-12">
                <div className="space-y-6">
                  ...
                  <JsonArrayInput
                    ...
                    currentCount={formData.learningOutcomes?.length || 0}
            ...
            {activeSection === 'career' && (
              <div className="space-y-10">
                ...
                <JsonArrayInput
                  ...
                  currentCount={formData.careerOpportunities?.length || 0}
            ...
            {activeSection === 'faculty' && (
              <div className="space-y-10">
                ...
                <JsonArrayInput
                  fieldName="faculty"
                  currentCount={formData.faculty?.length || 0}
            ...
            {activeSection === 'projects' && (
              <div className="space-y-10">
                ...
                <JsonArrayInput
                  fieldName="projects"
                  currentCount={formData.projects?.length || 0}
            ...
            {activeSection === 'faqs' && (
              <div className="space-y-10">
                ...
                <JsonArrayInput
                  fieldName="faqs"
                  currentCount={formData.faqs?.length || 0}
