...
import {
  COLLEGE_ADDRESS_TEXT,
  COLLEGE_NAME,
  COLLEGE_PHONE_DISPLAY,
  COLLEGE_PHONE_TEL,
  SITE_URL,
} from '@/lib/seo-schema';
...
const Footer = () => {
  return (
    <footer className="relative w-full bg-black text-white overflow-hidden" itemScope itemType="https://schema.org/LocalBusiness">
      <meta itemProp="name" content={COLLEGE_NAME} />
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-wrap gap-4">
              {[
                ...
                { name: 'LinkedIn', href: 'https://www.linkedin.com/school/itahari-international-college/', path: 'M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6z M2 9h4v12H2z M4 2a2 2 0 110 4 2 2 0 010-4z', filled: false },
          ...
          <div>
            ...
            <ul className="flex flex-col gap-5 sm:gap-6">
              ...
              <li className="flex items-center gap-4">
                ...
                <a href={`tel:${COLLEGE_PHONE_TEL}`} className="text-white/60 text-base font-iic hover:text-[#74C044] transition-colors" itemProp="telephone">{COLLEGE_PHONE_DISPLAY}</a>
              </li>
              <li className="flex items-center gap-4">
