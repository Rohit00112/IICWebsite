      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 pt-32 pb-16">
        ...
        >
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="text-white/60 text-base md:text-lg leading-relaxed max-w-sm font-sora">
          ...
          {/* Contact Us */}
          <div>
            <h4 className="text-xl font-bold mb-8 font-sora text-white">Contact Us</h4>
            <ul className="flex flex-col gap-6">
              <li className="flex items-start gap-4">
                ...
                <span className="text-white/60 text-base leading-relaxed font-sora">Sundar Haraicha 04, Itahari, Sunsari, Nepal</span>
              </li>
              <li className="flex items-center gap-4">
                <svg className="w-6 h-6 text-[#007a5e] shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                <span className="text-white/60 text-base font-sora">+977 9869258083</span>
              </li>
              <li className="flex items-center gap-4">
                ...
                <span className="text-white/60 text-base font-sora">info@iic.edu.np</span>
              </li>
            </ul>
          </div>
        </AnimeStagger>
        ...
        <div className="pt-12 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/40 text-sm font-sora">
