      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="lg:w-[50%] flex flex-col text-white">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-[#3E6B24] rounded-xl flex items-center justify-center mb-6 md:mb-10 shadow-lg">
            ...
            <AnimeReveal
              ...
              className="text-2xl md:text-4xl font-black mb-5 md:mb-8 font-sora leading-[1.15] tracking-tight"
              staggerFrom="first"
            />

            <p className="text-white/90 text-sm md:text-base font-medium leading-relaxed mb-6 md:mb-10 font-sora">
          ...
          <div className="lg:w-[50%] flex flex-col gap-5 md:gap-8">
            ...
            {/* Recognition Box */}
            <div className="bg-[#467528] rounded-2xl md:rounded-[2rem] p-5 md:p-10 flex items-start gap-4 md:gap-8 border-l-4 md:border-l-[6px] border-[#A3E635] shadow-2xl relative overflow-hidden">
              <div className="shrink-0 mt-0.5 text-[#A3E635]">
