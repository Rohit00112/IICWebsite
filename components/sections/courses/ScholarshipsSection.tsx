            ...
            >
              <Tilt strength={10} className="w-full h-full">
                <div className="scholarship-card h-full bg-white p-10 rounded-[32px] shadow-xl shadow-[#21409A]/5 border border-white flex flex-col">
                  ...
                  <button className="mt-auto w-full py-4 bg-[#1a1a1a] text-white rounded-xl font-bold text-[12px] hover:bg-[#21409A] transition-colors flex items-center justify-center gap-2">
                    Learn More
            ...
            >
              <Tilt strength={6} className="w-full h-full">
                <div className="scholarship-card h-full bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white/60 flex flex-col">
                  ...
                  <button className="mt-auto w-full py-4 border-2 border-[#1a1a1a]/10 bg-white/80 text-[#1a1a1a] rounded-xl font-bold text-[12px] hover:border-[#21409A] hover:text-[#21409A] transition-all">
                    Contact Admissions
                  </button>
                </div>
              </Tilt>
