        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:gap-32">
          ...
          <div className="w-full lg:w-[65%] flex flex-col md:flex-row gap-8">
            ...
            >
              <Tilt strength={10} className="w-full h-full">
                <div className="scholarship-card h-full bg-white p-10 rounded-[32px] shadow-xl shadow-[#21409A]/5 border border-white flex flex-col">
                  ...
                  <Link href="/scholarship" className="mt-auto w-full py-4 bg-[#1a1a1a] text-white rounded-xl font-bold text-[12px] hover:bg-[#21409A] transition-colors flex items-center justify-center gap-2">
                    Learn More
            ...
            <motion.div 
              ...
              className="flex-1"
            >
              <Tilt strength={6} className="w-full h-full">
                <div className="scholarship-card h-full bg-white/50 backdrop-blur-sm p-10 rounded-[32px] border border-white/60 flex flex-col">
                  ...
                  <Link href="/contact-us" className="mt-auto w-full py-4 border-2 border-[#1a1a1a]/10 bg-white/80 text-[#1a1a1a] text-center rounded-xl font-bold text-[12px] hover:border-[#21409A] hover:text-[#21409A] transition-all">
                    Contact Admissions
                  </Link>
                </div>
              </Tilt>
