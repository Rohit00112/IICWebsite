...
const AdmissionsSidebar = ({ isSubmitted = false }: AdmissionsSidebarProps) => {
  ...
  const resources = [
    { name: 'Download College Brochure', icon: <BookIcon />, gated: true, href: '/IIC%20Prospectus.pdf' },
  ];
        ...
        <div className="relative overflow-hidden bg-white rounded-[24px] p-8 shadow-[0_20px_50px_rgba(0,0,0,0.04)] border border-gray-100">
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Magnetic strength={0.1}>
                <ObfuscatedEmailLink mailbox="admissions" className="w-full py-3.5 bg-white text-[#21409A] border border-gray-100 rounded-xl text-[13px] font-bold flex items-center justify-center gap-3 hover:bg-gray-50 transition-all">
