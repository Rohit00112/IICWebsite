      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 flex flex-col items-center text-center">
        ...
        >
          {steps.map((step) => (
            <div
              key={step.id}
              className="step-card group p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-center transition-all hover:bg-white/10 hover:border-white/20"
            >
              <motion.div
                layout
