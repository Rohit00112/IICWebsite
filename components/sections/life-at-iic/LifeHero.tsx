    ...
    <section ref={containerRef} className="relative min-h-[100svh] w-full overflow-hidden bg-white flex items-center justify-center pt-24 pb-12 px-4 md:px-8">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          <RevealText 
            text="Life At"
            className="text-6xl md:text-8xl lg:text-[110px] font-black leading-[1.1] tracking-tight font-sora text-[#1a1a1a] justify-center"
          />
          <div className="text-[#21409A] relative inline-block">
            <RevealText 
              text="IIC"
              className="text-6xl md:text-8xl lg:text-[110px] font-black leading-[1.1] tracking-tight font-sora justify-center"
              delay={0.4}
            />
            {/* Green SVG Underline */}
            <motion.svg 
              ...
              className="absolute -bottom-2 md:-bottom-4 left-0 w-full origin-left" 
              viewBox="0 0 200 30" 
              fill="none" 
        ...
        <motion.p 
          ...
          className="max-w-[750px] mx-auto text-[#333333] text-base md:text-xl font-medium leading-relaxed mb-12 font-sora"
        >
