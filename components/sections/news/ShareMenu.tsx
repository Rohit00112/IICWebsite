  ...
  const shareInstagram = async (e: React.MouseEvent) => {
    ...
    if (typeof navigator !== 'undefined' && 'share' in navigator) {
      try {
        ...
        // user cancelled or share failed — fall through to copy + info
      }
    }
    try {
        ...
        {open && (
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[#E1306C]/5 text-left transition-colors"
            >
              <span className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#FEDA75] via-[#FA7E1E] via-40% to-[#D62976] flex items-center justify-center text-white shrink-0">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              <span className="text-sm font-bold text-[#1a1a1a]">Instagram</span>
            </button>
