...
const defaultGalleries: EventGalleryItem[] = [
  {
    ...
    year: 2025,
    summary: 'A campus-wide celebration of music, food, and student-led performances marking the season.',
  ...
  },
  {
    ...
    slug: 'sports-week',
    year: 2025,
    summary: 'A week of futsal, basketball, table tennis, and athletics across campus.',
