  ...
  return (
    <div className="max-w-[1600px] mx-auto pb-20">
      ...
      <div className="mb-12 flex items-end justify-between border-b border-gray-100 pb-10">
        <div>
          <h1 className="text-5xl font-black text-[#1A2B56] font-sora tracking-tight mb-3">Create Article</h1>
          <p className="text-gray-500 font-medium text-lg font-sora">Write in Markdown with high-fidelity site preview.</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        {/* Content Area */}
        <div className="lg:col-span-9 bg-white p-12 rounded-[40px] border border-gray-100 shadow-sm min-h-[700px] transition-all">
                ...
                <div className="grid grid-cols-2 gap-8 animate-in fade-in slide-in-from-top-4 duration-500">
                  ...
                  <div className="space-y-3">
                    ...
                    <input 
                      ...
                      placeholder="e.g. IT Lab 1, Main Block"
                      className="form-input-admin"
                    />
                  </div>
                </div>
            ...
            <div className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
              <div className="flex items-center justify-between">
                <div className="space-y-2">
                  <h3 className="text-2xl font-black text-[#1A2B56] font-sora tracking-tight">Article Content</h3>
            ...
            <div className="space-y-10 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              <div className="space-y-3">
                ...
                <textarea 
                  ...
                  placeholder="A concise summary for social sharing and search results..."
