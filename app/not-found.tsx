  ...
  return (
    <main className="min-h-screen bg-[#F4F7FA] flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center relative overflow-hidden py-32">
        ...
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[#74C044]/5 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/3 pointer-events-none" />
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full">
              <h2 className="text-3xl md:text-5xl font-black text-[#21409A] font-iic tracking-tight">
                Page Not Found
              </h2>
            </div>
          </motion.div>
